...
// PLACEHOLDER: คืนเส้นตำแหน่ง "โดยประมาณ" ตามสัดส่วนฝ่ามือมาตรฐาน
// TODO(cv): แทนที่ด้วย line-segmentation model จริง — interface คงเดิม
ScanTools.detectPalmLines = async function (_dataUrl) {
  return {
    isMock: true,
    lines: [
      { key: "life",  th: "เส้นชีวิต",  color: "#6fd39b", path: [[0.38, 0.38], [0.33, 0.52], [0.33, 0.68], [0.40, 0.84]] },
      { key: "head",  th: "เส้นสมอง",  color: "#5b8fd9", path: [[0.36, 0.42], [0.52, 0.47], [0.68, 0.50], [0.80, 0.55]] },
      { key: "heart", th: "เส้นหัวใจ", color: "#f08bb4", path: [[0.30, 0.33], [0.48, 0.28], [0.66, 0.26], [0.82, 0.29]] },
      { key: "fate",  th: "เส้นวาสนา", color: "#e6c36b", path: [[0.55, 0.85], [0.54, 0.65], [0.53, 0.45], [0.52, 0.30]] }
    ]
  };
};
