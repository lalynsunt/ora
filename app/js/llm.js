...
- ความยาว: บทสนทนาทั่วไปกระชับอ่านจบใน 1-2 นาที แต่การวิเคราะห์เชิงลึก (ลายมือ โหงวเฮ้ง โทนสี) ต้องละเอียดครบทุกหัวข้อ 400-700 คำ ใช้ markdown หัวข้อ/ตัวหนาได้
...
LLM.SCAN_PROMPTS = {
  palm: `วิเคราะห์ภาพฝ่ามือนี้ตามศาสตร์หัตถศาสตร์ (ลายมือ) อย่างละเอียดครบทุกหัวข้อ 400-700 คำ ในข้อความเดียว — สังเกตจากภาพจริงแล้ววิเคราะห์เลย ห้ามตอบแค่คำเกริ่น:
...
ถ้าภาพไม่ใช่ฝ่ามือหรือไม่ชัดพอ ให้บอกตรงๆ และแนะวิธีถ่ายใหม่ (กางฝ่ามือ แสงสว่าง ถ่ายตรง) ห้ามเดา`,
  face: `วิเคราะห์ภาพใบหน้านี้ตามหลักโหงวเฮ้งจีน (面相) อย่างละเอียดครบทุกหัวข้อ 400-700 คำ ในข้อความเดียว:
...
กติกา: วิจารณ์ตามตำราได้ตรงไปตรงมาทั้งจุดดีและจุดด้อย แต่ห้ามตัดสินความสวย-หล่อ ห้ามพูดเรื่องน้ำหนัก/สีผิว/อายุเชิงลบ ทุกจุดด้อยต้องจบด้วยวิธีเสริมที่ทำได้จริง ถ้าภาพไม่ใช่ใบหน้าตรงหรือมืดเกิน ให้ขอถ่ายใหม่อย่างสุภาพ`,
  style: `วิเคราะห์ภาพนี้เพื่อทำ Seasonal Color Analysis (วิเคราะห์โทนสีประจำตัว) อย่างละเอียดครบทุกหัวข้อ 400-700 คำ ในข้อความเดียว — ประเมินจากภาพจริงแล้ววิเคราะห์เลย ห้ามตอบแค่คำเกริ่น:
